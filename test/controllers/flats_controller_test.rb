...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference("Flat.count") do
      post flats_url, params: { flat: { address: @flat.address, description: @flat.description, image_url: @flat.image_url, name: @flat.name, occupancy: @flat.occupancy, price: @flat.price, user_id: @flat.user_id } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { address: @flat.address, description: @flat.description, image_url: @flat.image_url, name: @flat.name, occupancy: @flat.occupancy, price: @flat.price, user_id: @flat.user_id } }
